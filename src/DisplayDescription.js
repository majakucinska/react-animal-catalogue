...
export default function DisplayDescription(){
    ...
    let [dogBreed, setDogBreed] = useState();
        ...
        function afghanHoundDescription(event){
            ...
            setDogBreed("The Afghan is one of the oldest breeds, getting his start thousands of years ago in a remote region of what is now Afghanistan, Pakistan, and India.\n" +
        ...
        function alaskanMalamuteDescription(event){
            event.preventDefault();
            setDogBreed("The Alaskan Malamute can be traced back over 4,000 years to the Arctic, where he was used primarily as a hunting companion and sled dog by the Inuit people. Today, he’s still a favorite on sled teams, though unlike huskies, he’s prized for power rather than speed and endurance. Weighing up to 85 pounds, he’s a large, muscular pup, so early obedience training is a must to establish manners before he’s too strong for his own good.\n" +
        ...
        function chowChowDescription(event){
            event.preventDefault();
            setDogBreed("The Chow Chow dates back over 2,000 years to the Han Dynasty of China. He’s held many roles in that time, serving as a hunting dog, guardian, hauler, and pampered royal pet.\n"+
        ...
        function samoyedDescription(event){
            event.preventDefault();
            setDogBreed("This smiling sweetheart dates back over 2,000 years to the Samoyedic people of modern-day Siberia. The Samoyed was a multipurpose companion for the tribe, functioning as a hunting dog, sled puller, watchdog, and warming buddy thanks to his dense coat. Today, the Samoyed is still a beloved sled puller, though he also excels as a hiking, biking, or jogging companion.\n"+ 
